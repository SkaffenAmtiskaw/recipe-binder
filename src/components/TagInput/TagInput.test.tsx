...
test.serial(
  'should not allow a user to add a new value when restrict is set',
  async (t) => {
    t.plan(1);
...
test.serial(
  'should allow a user to add a value to the array via autocomplete',
  async (t) => {
    t.plan(1);
...
test.serial(
  'should allow a user to remove a value from the array',
  async (t) => {
    t.plan(1);
